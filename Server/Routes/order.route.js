...
// CREATE ORDER
orderRouter.post('/', protect, asyncHandler(orderController.placeOrder));
...
orderRouter.get(
    ...
    // protect,
    // admin,
    asyncHandler(orderController.getAllOrdersByAdmin),
);
// USER LOGIN ORDERS
orderRouter.get('/', protect, asyncHandler(orderController.getOrders));

// GET ORDER BY ID
orderRouter.get('/:id', protect, asyncHandler(orderController.getOrder));
...
orderRouter.get('/:id/address', protect, asyncHandler(orderController.getOrderShippingAddress));
